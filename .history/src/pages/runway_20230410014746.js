      ...
      <footer aria-label="Site Footer" class="bg-white dark:bg-gray-900">
        <div class="mx-auto max-w-screen-xl px-4 pt-16 pb-6 sm:px-6 lg:px-8 lg:pt-24">
          <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
            <div>
              <div class="flex justify-center text-teal-600 dark:text-teal-300 sm:justify-start">
                <svg
                  class="h-8"
                  viewBox="0 0 118 24"
                  fill="none"
              ...
              <p class="mt-6 max-w-md text-center leading-relaxed text-gray-500 dark:text-gray-400 sm:max-w-xs sm:text-left">
                  ...
                  <ul class="space-y-4 text-sm">
                    ...
                    <li>
                      <a
                        ...
                        href="/">
                        <span class="text-gray-700 transition group-hover:text-gray-700/75 dark:text-white dark:hover:text-white/75">
                          Live Chat
                        </span>
              ...
              <div class="text-center sm:text-left">
                ...
                <ul class="mt-8 space-y-4 text-sm">
                  ...
                  <li class="flex items-start justify-center gap-1.5 sm:justify-start">
                    ...
                    <address class="-mt-0.5 not-italic text-gray-700 dark:text-gray-300">
